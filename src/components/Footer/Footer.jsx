  ...
  return (
    ...
    <p>
      ...
      <div className="text-center ">
        <p>&copy; {new Date().getFullYear()} Park Hřiště. Všechna práva vyhrazena. <strong>Věnováno <span className="animate-pulse">Luďkovi</span> a <span className="animate-pulse">Aleně</span></strong></p>
      </div>
    </footer>
  );
}