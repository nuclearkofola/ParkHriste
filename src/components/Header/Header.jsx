...
export function Header() {
  ...
  const [theme, setTheme] = useState('clight'); // default custom light theme
  ...
  useEffect(() => {
    try {
      ...
      if (saved) {
        ...
        // If system prefers dark and no saved theme, optionally adopt it (optional logic)
  ...
  const toggleTheme = () => {
    const next = (theme === 'cdark' || theme === 'dark') ? 'clight' : 'cdark';
    setTheme(next);
    applyTheme(next);
    try { localStorage.setItem('theme', next); } catch(_) {}
  };
  // use DaisyUI active button class
  ...
  return (
    <header className={headerClass}>
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        {/* Logo a název - mobilni zobrazeni */}
        ...
        <div className="flex items-center space-x-2">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            <button
              ...
              onClick={toggleTheme}
              className="hidden lg:inline-flex btn btn-square btn-ghost ml-1"
            >
              {theme === 'cdark' || theme === 'dark' ? (
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-base-100 shadow-md z-50">
          <nav className="flex flex-col py-2">
            ...
            <div className="px-4 py-2 flex items-center">
              ...
              >
                {theme === 'cdark' || theme === 'dark' ? 'Vypnout' : 'Zapnout'}
              </button>
            </div>
          </nav>
        </div>
